...
mixin _$BaseResponseDto<T> {
 ...
 String get status; RequestDto get request; T? get data;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is BaseResponseDto<T>&&(identical(other.status, status) || other.status == status)&&(identical(other.request, request) || other.request == request)&&const DeepCollectionEquality().equals(other.data, data));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,status,request,const DeepCollectionEquality().hash(data));

@override
String toString() {
  return 'BaseResponseDto<$T>(status: $status, request: $request, data: $data)';
}
...
@useResult
$Res call({
 String status, RequestDto request, T? data
});
...
/// Create a copy of BaseResponseDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? request = null,Object? data = freezed,}) {
  return _then(_self.copyWith(
status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as String,request: null == request ? _self.request : request // ignore: cast_nullable_to_non_nullable
as RequestDto,data: freezed == data ? _self.data : data // ignore: cast_nullable_to_non_nullable
as T?,
  ));
}
/// Create a copy of BaseResponseDto
...
$RequestDtoCopyWith<$Res> get request {
  ...
  return $RequestDtoCopyWith<$Res>(_self.request, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  RequestDto request,  T? data)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _BaseResponseDto() when $default != null:
return $default(_that.status,_that.request,_that.data);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  RequestDto request,  T? data)  $default,) {final _that = this;
switch (_that) {
case _BaseResponseDto():
return $default(_that.status,_that.request,_that.data);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  RequestDto request,  T? data)?  $default,) {final _that = this;
switch (_that) {
case _BaseResponseDto() when $default != null:
return $default(_that.status,_that.request,_that.data);case _:
  return null;
...
class _BaseResponseDto<T> implements BaseResponseDto<T> {
  const _BaseResponseDto({required this.status, required this.request, this.data});
...
@override final  RequestDto request;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BaseResponseDto<T>&&(identical(other.status, status) || other.status == status)&&(identical(other.request, request) || other.request == request)&&const DeepCollectionEquality().equals(other.data, data));
}
...
@override $RequestDtoCopyWith<$Res> get request;
...
/// Create a copy of BaseResponseDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? request = null,Object? data = freezed,}) {
